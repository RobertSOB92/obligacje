...
export function Layout({ formPanel, chartPanel, tablePanel }: LayoutProps) {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main content */}
      <main className="flex-1 w-full px-4 sm:px-6 md:px-8 pb-12 sm:pb-16 flex justify-center items-start">
        
        {/* The MASTER BOX containing everything */}
        <div className="w-full max-w-6xl mx-auto flex flex-col gap-6 sm:gap-8 transition-all">
          
          {/* Form + Chart row */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
            {/* Form panel */}
            <section className="lg:col-span-5 xl:col-span-4 flex">
              <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm shadow-xl flex-1 flex flex-col p-8 sm:p-10">
            ...
            {/* Chart panel */}
            <section className="lg:col-span-7 xl:col-span-8 flex">
              <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm shadow-xl flex-1 p-6 sm:p-8">
                <h2 className="text-base font-semibold text-slate-200 mb-4 flex items-center gap-2">
          ...
          <section className="w-full">
            <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 backdrop-blur-sm shadow-xl p-6 sm:p-8">
              {tablePanel}
            </div>
          </section>
